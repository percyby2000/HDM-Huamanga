...
const Historia = () => {
  ...
  return (
    <div className="bg-black text-white pt-16 md:pt-20">
      {/* Hero Section */}


      {/* Hero Section */}
      <section className="py-8 sm:py-16 px-4 bg-gradient-to-b from-gray-900 to-black">
      ...
      <section className="py-12 sm:py-16 px-4 bg-black">
        <div className="container mx-auto">
          ...
          <div className="w-16 h-1 bg-white mx-auto mb-10 sm:mb-12"></div>
      ...
      <section className="py-12 sm:py-16 px-4 bg-gradient-to-b from-black to-gray-900">
        <div className="container mx-auto">
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <div className="md:hidden absolute left-6 top-0 bottom-0 w-0.5 bg-blue-500"></div>
            ...
            <div className="mb-12 sm:mb-16 relative animate-on-scroll opacity-0 translate-y-12 transition-all duration-1000" style={{transitionDelay: '200ms'}}>
              ...
              <div className="bg-gradient-to-br from-gray-900 to-black p-5 sm:p-6 rounded-xl shadow-xl border border-gray-800 ml-12 md:ml-0 md:mr-auto md:w-[calc(50%-20px)]">
            ...
            <div className="mb-12 sm:mb-16 relative animate-on-scroll opacity-0 translate-y-12 transition-all duration-1000" style={{transitionDelay: '400ms'}}>
              ...
              <div className="bg-gradient-to-br from-gray-900 to-black p-5 sm:p-6 rounded-xl shadow-xl border border-gray-800 ml-12 md:ml-auto md:mr-0 md:w-[calc(50%-20px)]">
      ...
      <section className="py-12 sm:py-16 px-4 bg-gradient-to-b from-gray-900 to-black">
        <div className="container mx-auto text-center">
          <div className="max-w-3xl mx-auto bg-gradient-to-br from-gray-900 to-black p-8 sm:p-10 rounded-2xl border border-gray-800 shadow-xl animate-on-scroll opacity-0 scale-95 transition-all duration-1000">
            ...
            <button className="bg-gradient-to-r from-blue-600 to-blue-800 text-white font-bold py-3 px-8 rounded-lg hover:from-blue-700 hover:to-blue-900 transition-all shadow-lg transform hover:scale-105">
              Contáctanos
            </button>
          </div>
        </div>
